...
// Create tectonic layer for our map
...
// Accessing the tectonic plate routes GeoJSON URL
...
L.geoJson(data, {
  ...
  pointToLayer: function(feature, latlng) {
        ...
        style: styleInfo,
        // We create a popup for each circleMArker to display the magnitude and location of the earthwauke after the marker has been created and styled
...
// Retrieve tectonic data
  d3.json(tectonic).then(function(data) {
    ...
    // Creating a GeoJSON layer with the retrieved tectonic data
    L.geoJson(data, {style: myStyle}).addTo(tectonics);

    // Then we add to tectonic layer to our map
    tectonics.addTo(map)
